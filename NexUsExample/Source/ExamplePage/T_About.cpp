    ...
    : NXDialog(parent)
{
  ...
  setWindowIcon(QIcon(QStringLiteral(":/Resource/Image/Moon.jpg")));
  ...
  pixCard->setCardImage(QImage(QStringLiteral(":/Resource/Image/Moon.jpg")));

  QVBoxLayout *pixCardLayout = new QVBoxLayout();
  pixCardLayout->addWidget(pixCard);
  pixCardLayout->addStretch();

  NXText *versionText   = new NXText(QStringLiteral("NexUs-LK-2024"), this);
