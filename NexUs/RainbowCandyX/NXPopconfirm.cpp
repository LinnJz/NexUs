...
Q_PROPERTY_CREATE_CPP(NXPopconfirm, QString, Title)
Q_PROPERTY_CREATE_CPP(NXPopconfirm, QString, Content)
Q_PROPERTY_CREATE_CPP(NXPopconfirm, QString, ConfirmButtonText)
Q_PROPERTY_CREATE_CPP(NXPopconfirm, QString, CancelButtonText)
Q_PROPERTY_CREATE_CPP(NXPopconfirm, NXIconType::IconName, Icon)
Q_PROPERTY_CREATE_CPP(NXPopconfirm, bool, IsLightDismiss)

NXPopconfirm::NXPopconfirm(QWidget *parent) : QWidget{nullptr}, d_ptr(new NXPopconfirmPrivate())
{
	Q_D(NXPopconfirm);
	d->q_ptr = this;
	d->_pBorderRadius = 8;
...
void NXPopconfirm::showPopconfirm(QWidget *target)
{
	Q_D(NXPopconfirm);
	if (!target)
	{
...
void NXPopconfirm::closePopconfirm()
{
	Q_D(NXPopconfirm);
...
void NXPopconfirm::paintEvent(QPaintEvent *event)
{
	Q_D(NXPopconfirm);
...
bool NXPopconfirmPrivate::eventFilter(QObject *watched, QEvent *event)
{
	Q_Q(NXPopconfirm);
...
void NXPopconfirmPrivate::_doShowAnimation()
{
