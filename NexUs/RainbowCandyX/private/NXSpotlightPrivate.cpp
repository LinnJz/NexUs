...
void NXSpotlightPrivate::_showStep(int index, bool animate)
{
    Q_Q(NXSpotlight);
...
void NXSpotlightPrivate::_updateOverlay()
{
    Q_Q(NXSpotlight);
    if (_currentTarget)
    {
...
void NXSpotlightPrivate::_updateTipPosition()
{
    Q_Q(NXSpotlight);
    if (!_currentTarget)
    {
...
QRectF NXSpotlightPrivate::_getTargetRect(QWidget* target) const
{
