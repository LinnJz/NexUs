...
void
NXCodeEditorPrivate::onThemeChanged(NXThemeType::ThemeMode themeMode)
{
  Q_Q(NXCodeEditor);
  ...
  _editor->setStyleSheet(QString(QStringLiteral("QPlainTextEdit { background-color: %1; color: %2; }"))
...
void
NXCodeEditor::setCode(const QString &Code)
{
  Q_D(NXCodeEditor);
  if (d->_pCode != Code)
  {
...
QString
NXCodeEditor::getCode() const
{
  return d_ptr->_pCode;
}

void
NXCodeEditor::setLanguage(Language lang)
{
  Q_D(NXCodeEditor);
...
NXCodeEditor::Language
NXCodeEditor::getLanguage() const
{
    ...
    , d_ptr(new NXCodeEditorPrivate())
{
  ...
  QFont monoFont;
#if defined(Q_OS_MAC)
  monoFont = QFont(QStringLiteral("Courier New"), 13);
#elif defined(Q_OS_WIN)
  monoFont = QFont(QStringLiteral("Consolas"), 13);
#else
  monoFont = QFont(QStringLiteral("Monospace"), 13);
#endif
  ...
  d->_editor->setStyleSheet(QString(QStringLiteral("QPlainTextEdit { background-color: %1; color: %2; }"))
