...
Q_PROPERTY_CREATE_CPP(NXStatCard, QS_SET_CREF(QString), Title)
Q_PROPERTY_CREATE_CPP(NXStatCard, QS_SET_CREF(QString), Value)
Q_PROPERTY_CREATE_CPP(NXStatCard, QS_SET_CREF(QString), Description)
...
void
NXStatCard::setTrend(TrendType trend)
{
  Q_D(NXStatCard);
  d->_trend = trend;
  update();
...
NXStatCard::TrendType
NXStatCard::getTrend() const
{
  return d_ptr->_trend;
}

void
NXStatCard::setTrendText(const QString &text)
{
  Q_D(NXStatCard);
  d->_trendText = text;
  update();
...
QString
NXStatCard::getTrendText() const
{
  return d_ptr->_trendText;
}

void
NXStatCard::paintEvent(QPaintEvent *event)
{
  Q_UNUSED(event)
  Q_D(NXStatCard);
