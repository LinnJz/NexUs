...
#include "NXTheme.h"
#include "private/NXFlyoutPrivate.h"
Q_PROPERTY_CREATE_CPP(NXFlyout, QS_SET_CREF(QString), Title)
Q_PROPERTY_CREATE_CPP(NXFlyout, QS_SET_CREF(QString), Content)
...
void
NXFlyout::setContentWidget(QWidget *widget)
{
  Q_D(NXFlyout);
...
void
NXFlyout::showFlyout(QWidget *target)
{
  Q_D(NXFlyout);
  if (!target)
  {
...
void
NXFlyout::paintEvent(QPaintEvent *event)
{
  Q_D(NXFlyout);
...
bool
NXFlyoutPrivate::eventFilter(QObject *watched, QEvent *event)
{
  Q_Q(NXFlyout);
...
void
NXFlyoutPrivate::_doShowAnimation()
{
