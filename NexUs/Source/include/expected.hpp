...
namespace tl
{
  ...
  public:
    ...
    TL_EXPECTED_11_CONSTEXPR explicit unexpected(
        in_place_t,
        std::initializer_list<_Uty> ilist,
        _Args&&...vals) noexcept(std::is_nothrow_constructible<E, std::initializer_list<_Uty>&, _Args...>::value)
