...
class NX_EXPORT NXAESEncryption : public QObject
{
  Q_OBJECT
public:
  enum Aes
   ...
   * \param isEncryptionKey:    always 'true' || only 'false' when DECRYPTING in CBC or EBC mode with aesni (check if
   * supported)
