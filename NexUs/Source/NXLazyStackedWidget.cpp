...
QWidget *
NXLazyStackedWidget::ensureWidget(int index) noexcept
{
  Q_D(NXLazyStackedWidget);
...
bool
NXLazyStackedWidget::isWidgetCreated(int index) const noexcept
{
...
QWidget *
NXLazyStackedWidget::currentWidget() const noexcept
{
  Q_D(const NXLazyStackedWidget);
...
int
NXLazyStackedWidget::currentIndex() const noexcept
{
  Q_D(const NXLazyStackedWidget);
...
int
NXLazyStackedWidget::indexOf(const QWidget *widget) const noexcept
{
  Q_D(const NXLazyStackedWidget);
...
QWidget *
NXLazyStackedWidget::widget(int index) const noexcept
{
  Q_D(const NXLazyStackedWidget);
...
int
NXLazyStackedWidget::count() const noexcept
{
  Q_D(const NXLazyStackedWidget);
