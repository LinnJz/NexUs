...
#ifndef GENO_CONVERT_LIT_ENDIAN_VAX_H
#define GENO_CONVERT_LIT_ENDIAN_VAX_H
...
class NX_PACKETIO_EXPORT GenOConvertLitEndianVax : public GenOConvertLitEndianInt
{
public:
    // Constructor
